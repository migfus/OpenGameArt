...
use App\Models\{Art, ArtCategory, ArtPreview, ArtPreviewCategory, Tag, User, ArtComment, ArtType, Collection, File};
...
class ArtController extends Controller {
    ...
    public function index(Request $req) {
        ...
        // dd($req->integer('field_art_type_tid') === 0 ? $art_types_id : [$req->integer('field_art_type_tid')]);
