import{C as e,D as t,F as n,H as r,I as i,M as a,N as o,P as s,Q as c,S as l,U as u,_ as d,ct as f,et as p,f as m,g as h,h as g,i as _,j as v,n as y,r as b,st as x,t as S,ut as C,v as w,x as T,y as E}from"./DataTransition-CThTXB6O.js";import{a as ee,d as D,f as O,n as k,o as A,r as j,s as M,t as N,u as P}from"./keyboard-YiKPEj16.js";import{l as te,r as F,t as I}from"./app-C29zr71-.js";import{t as L}from"./NotifyBanner-CcxWf3y1.js";var R=(e=>(e[e.Open=0]=`Open`,e[e.Closed=1]=`Closed`,e))(R||{}),z=Symbol(`DisclosureContext`);function B(e){let n=t(z,null);if(n===null){let t=Error(`<${e} /> is missing a parent <Disclosure /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(t,B),t}return n}var V=Symbol(`DisclosurePanelContext`);function H(){return t(V,null)}var U=e({name:`Disclosure`,props:{as:{type:[Object,String],default:`template`},defaultOpen:{type:[Boolean],default:!1}},setup(e,{slots:t,attrs:n}){let r=p(e.defaultOpen?0:1),i=p(null),a=p(null),o={buttonId:p(`headlessui-disclosure-button-${O()}`),panelId:p(`headlessui-disclosure-panel-${O()}`),disclosureState:r,panel:i,button:a,toggleDisclosure(){r.value=P(r.value,{0:1,1:0})},closeDisclosure(){r.value!==1&&(r.value=1)},close(e){o.closeDisclosure(),(e?e instanceof HTMLElement?e:e.value instanceof HTMLElement?D(e):D(o.button):D(o.button))?.focus()}};return s(z,o),ee(g(()=>P(r.value,{0:k.Open,1:k.Closed}))),()=>{let{defaultOpen:i,...a}=e;return A({theirProps:a,ourProps:{},slot:{open:r.value===0,close:o.close},slots:t,attrs:n,name:`Disclosure`})}}}),W=e({name:`DisclosureButton`,props:{as:{type:[Object,String],default:`button`},disabled:{type:[Boolean],default:!1},id:{type:String,default:null}},setup(e,{attrs:t,slots:n,expose:i}){let o=B(`DisclosureButton`),s=H(),c=g(()=>s===null?!1:s.value===o.panelId.value);v(()=>{c.value||e.id!==null&&(o.buttonId.value=e.id)}),a(()=>{c.value||(o.buttonId.value=null)});let l=p(null);i({el:l,$el:l}),c.value||r(()=>{o.button.value=l.value});let u=te(g(()=>({as:e.as,type:t.type})),l);function d(){var t;e.disabled||(c.value?(o.toggleDisclosure(),(t=D(o.button))==null||t.focus()):o.toggleDisclosure())}function f(t){var n;if(!e.disabled)if(c.value)switch(t.key){case N.Space:case N.Enter:t.preventDefault(),t.stopPropagation(),o.toggleDisclosure(),(n=D(o.button))==null||n.focus();break}else switch(t.key){case N.Space:case N.Enter:t.preventDefault(),t.stopPropagation(),o.toggleDisclosure();break}}function m(e){switch(e.key){case N.Space:e.preventDefault();break}}return()=>{let r={open:o.disclosureState.value===0},{id:i,...a}=e;return A({ourProps:c.value?{ref:l,type:u.value,onClick:d,onKeydown:f}:{id:o.buttonId.value??i,ref:l,type:u.value,"aria-expanded":o.disclosureState.value===0,"aria-controls":o.disclosureState.value===0||D(o.panel)?o.panelId.value:void 0,disabled:e.disabled?!0:void 0,onClick:d,onKeydown:f,onKeyup:m},theirProps:a,slot:r,attrs:t,slots:n,name:`DisclosureButton`})}}}),G=e({name:`DisclosurePanel`,props:{as:{type:[Object,String],default:`div`},static:{type:Boolean,default:!1},unmount:{type:Boolean,default:!0},id:{type:String,default:null}},setup(e,{attrs:t,slots:n,expose:r}){let i=B(`DisclosurePanel`);v(()=>{e.id!==null&&(i.panelId.value=e.id)}),a(()=>{i.panelId.value=null}),r({el:i.panel,$el:i.panel}),s(V,i.panelId);let o=j(),c=g(()=>o===null?i.disclosureState.value===0:(o.value&k.Open)===k.Open);return()=>{let r={open:i.disclosureState.value===0,close:i.close},{id:a,...o}=e;return A({ourProps:{id:i.panelId.value??a,ref:i.panel},theirProps:o,slot:r,attrs:t,slots:n,features:M.RenderStrategy|M.Static,visible:c.value,name:`DisclosurePanel`})}}}),K={class:`text-base font-semibold leading-7`},q=[`innerHTML`],J={key:0,class:`flex gap-2 mt-2 flex-wrap`},Y=e({__name:`CollapseSection`,props:{question:{},answer:{},show_all:{type:Boolean},buttons:{}},setup(e){return(t,r)=>(o(),d(x(U),{as:`div`},{default:u(({open:t})=>[h(`dt`,null,[l(x(W),{class:`flex w-full items-start justify-between text-left text-white cursor-pointer transition-all hover:bg-brand-950 px-4 py-2 rounded-2xl`},{default:u(()=>[h(`span`,K,C(e.question),1),l(y,{class:`ml-6 flex h-7 items-center`},{default:u(()=>[t||e.show_all?(o(),d(x(_),{key:0,icon:`memory:minus`,class:`size-6`,"aria-hidden":`true`})):(o(),d(x(_),{key:1,icon:`memory:menu-down`,class:`size-6 flex-none`,"aria-hidden":`true`}))]),_:2},1024)]),_:2},1024)]),l(y,null,{default:u(()=>[l(x(G),{as:`dd`,class:`mt-2 bg-brand-950 rounded-2xl py-2 px-4`},{default:u(()=>[h(`div`,{class:`text-base leading-7 text-gray-300`,innerHTML:e.answer},null,8,q),e.buttons.length>0?(o(),E(`div`,J,[(o(!0),E(m,null,n(e.buttons,e=>(o(),d(F,{title:e.title,external_link:``,href:e.href,icon:e.icon},{default:u(()=>[T(C(e.title),1)]),_:2},1032,[`title`,`href`,`icon`]))),256))])):w(``,!0)]),_:1})]),_:1})]),_:1}))}}),X={class:`flex justify-between`},Z={class:`text-base font-semibold leading-7 text-light-001 truncate`},ne=[`src`],re=[`innerHTML`],ie={key:0,class:`mt-2 transition-all flex flex-col justify-between gap-2`},Q=b(e({__name:`BasicCard`,props:{icon:{},iconHtml:{},iconImg:{},title:{},size:{},enableSearch:{type:Boolean},count:{},collapse:{type:Boolean},color:{}},setup(e){let t=e,n=p(t.collapse??!1),r=g(()=>{switch(t.size){case`sm`:return`p-4 sm:w-96 w-full`;default:return`p-4 sm:min-w-full`}});return(t,a)=>(o(),d(y,null,{default:u(()=>[h(`div`,{class:f([r.value,(e.color,`bg-brand-950`),` p-4 sm:rounded-2xl transition-all object-shadow border-y sm:border border-brand-900`])},[h(`div`,null,[h(`div`,X,[h(`h3`,Z,[e.icon?(o(),d(x(_),{key:0,icon:e.icon,class:`text-sm text-light-001 h-4 w-4 inline mr-3 mb-0.75 align-middle`},null,8,[`icon`])):e.iconImg?(o(),E(`img`,{key:1,src:e.iconImg,class:`inline mr-2 w-6 h-6 rounded shadow`},null,8,ne)):(o(),E(`div`,{key:2,class:`inline-block h-4 w-4 pt-0.5 text-light-001 mr-2`,innerHTML:e.iconHtml},null,8,re)),h(`span`,null,C(e.title),1)])])]),n.value?w(``,!0):(o(),E(`div`,ie,[i(t.$slots,`default`,{},void 0,!0)]))],2)]),_:3}))}}),[[`__scopeId`,`data-v-b991b491`]]),$={class:`p-6 flex flex-col gap-4 lg:grid grid-cols-3`},ae={class:`lg:order-last flex flex-col gap-4`},oe={class:`lg:col-span-2`},se={class:`bg-brand-950 p-4 sm:rounded-2xl mb-4`},ce=e({__name:`faqs`,setup(e){let t=c({search:``}),r=[{question:`Can I use the art I find here? How should I credit the artist?`,answer:`<p>
...
<ul class="list-disc pl-6">
                   ...
                   `,buttons:[]}],i=g(()=>{if(!t.search)return r;let e=t.search.toLowerCase();return r.filter(t=>t.question.toLowerCase().includes(e)||a(t.answer).toLowerCase().includes(e))}),a=e=>{let t=document.createElement(`div`);return t.innerHTML=e,t.textContent||t.innerText||``};return(e,r)=>(o(),E(`div`,null,[l(L),h(`div`,$,[h(`div`,ae,[l(Q,{icon:`memory:alert-box`,title:`Instruction`},{default:u(()=>[r[3]||=h(`p`,{class:``},`If you have a question that you think should be here, contact us via the Contact form and let us know.`,-1),l(F,{icon:`memory:chat`,external_link:``,href:`https://opengameart.org/contact`},{default:u(()=>[...r[1]||=[T(`Contact Form`,-1)]]),_:1}),r[4]||=h(`p`,{class:``},`Please read our content submission guidelines before posting art.`,-1),l(F,{icon:`memory:chat`,external_link:``,href:`https://opengameart.org/content/art-submission-guidelines`},{default:u(()=>[...r[2]||=[T(` Submission Guidelines `,-1)]]),_:1})]),_:1}),l(Q,{icon:`memory:alert-box`,title:`Forum Rules`},{default:u(()=>[...r[5]||=[h(`p`,null,[h(`strong`,null,`The basics:`)],-1),h(`ul`,{class:`list-disc pl-6`},[h(`li`,null,`No discussion of religion.`),h(`li`,null,`No discussion of politics, except relating directly to copyright, the Creative Commons, and/or FOSS.`),h(`li`,null,`Don't be racist, homophobic, or otherwise hateful.`)],-1),h(`br`,null,null,-1),h(`p`,null,[h(`strong`,null,`Conduct:`)],-1),h(`p`,null,` On some forums, it is okay to be snide.\xA0 That isn't acceptable here.\xA0 As a FOSS gaming community, we are ambassadors of FOSS in general, and as such it is not acceptable to be rude to people who are interested enough in what we do to take the time to ask questions.\xA0 Specifically, it is not okay to do the following: `,-1),h(`ul`,{class:`list-disc pl-6`},[h(`li`,null,`Say something along the lines of "READ TEH FAQ U IDIOT"`),h(`li`,null,`Reply to a question with a link to a google search`),h(`li`,null,`Say "SOMEONE ALREADY ASKED THIS READ TEH FORUM U IDIOT"`),h(`li`,null,`Talk down to anyone because of their choice of software or operating system`)],-1),h(`p`,null,[T(` On the other hand, it's quite possible that we'll get certain questions over and over, which is the reason FAQs exist in the first place.\xA0 It `),h(`em`,null,`is`),T(` acceptable to reply with a link to a relevant FAQ question `),h(`em`,null,`provided you read their post carefully and make sure that it actually applies`),T(`.\xA0 Just try to understand that when someone asks a question in a forum, they're looking for a personalized answer, and it's better to provide one and encourage discussion than just send them off to a FAQ link. `)],-1)]]),_:1})]),h(`div`,oe,[r[6]||=h(`h2`,{class:`text-2xl font-bold leading-10 tracking-tight text-white mb-6`},`Frequently asked questions`,-1),h(`div`,se,[l(I,{modelValue:t.search,"onUpdate:modelValue":r[0]||=e=>t.search=e,name:`Search`},null,8,[`modelValue`])]),l(S,{class:`flex flex-col gap-4`},{default:u(()=>[(o(!0),E(m,null,n(i.value,e=>(o(),d(Y,{question:e.question,answer:e.answer,show_all:t.search!=``,buttons:e.buttons},null,8,[`question`,`answer`,`show_all`,`buttons`]))),256))]),_:1}),r[7]||=h(`div`,{class:`TEST`},null,-1)])])]))}});export{ce as default};