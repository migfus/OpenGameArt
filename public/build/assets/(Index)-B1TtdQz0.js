import{_ as X,a as Z}from"./CarouselCard.vue_vue_type_script_setup_true_lang-BQfeNbee.js";import{G as f,H as D,R as N,S as m,d as C,U as Y,V as ee,i as k,W as O,X as B,I as H,Y as R,Z as te,$ as q,a0 as F,a1 as E,a2 as S,c as g,u as b,w as h,a as s,k as d,t as P,O as G,L,j as y,A as W,F as $,l as U,C as T,p as v,o as c,a3 as oe,K as se,a4 as ae,f as ie,_ as re,D as ne}from"./app-DujUDdWz.js";function j(e,a){if(e)return e;let i=a??"button";if(typeof i=="string"&&i.toLowerCase()==="button")return"button"}function le(e,a){let i=f(j(e.value.type,e.value.as));return D(()=>{i.value=j(e.value.type,e.value.as)}),N(()=>{var n;i.value||m(a)&&m(a)instanceof HTMLButtonElement&&!((n=m(a))!=null&&n.hasAttribute("type"))&&(i.value="button")}),i}var ue=(e=>(e[e.Open=0]="Open",e[e.Closed=1]="Closed",e))(ue||{});let V=Symbol("DisclosureContext");function _(e){let a=E(V,null);if(a===null){let i=new Error(`<${e} /> is missing a parent <Disclosure /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(i,_),i}return a}let z=Symbol("DisclosurePanelContext");function ce(){return E(z,null)}let de=C({name:"Disclosure",props:{as:{type:[Object,String],default:"template"},defaultOpen:{type:[Boolean],default:!1}},setup(e,{slots:a,attrs:i}){let n=f(e.defaultOpen?0:1),t=f(null),u=f(null),o={buttonId:f(`headlessui-disclosure-button-${Y()}`),panelId:f(`headlessui-disclosure-panel-${Y()}`),disclosureState:n,panel:t,button:u,toggleDisclosure(){n.value=O(n.value,{0:1,1:0})},closeDisclosure(){n.value!==1&&(n.value=1)},close(r){o.closeDisclosure();let p=r?r instanceof HTMLElement?r:r.value instanceof HTMLElement?m(r):m(o.button):m(o.button);p?.focus()}};return R(V,o),ee(k(()=>O(n.value,{0:q.Open,1:q.Closed}))),()=>{let{defaultOpen:r,...p}=e,w={open:n.value===0,close:o.close};return B({theirProps:p,ourProps:{},slot:w,slots:a,attrs:i,name:"Disclosure"})}}}),he=C({name:"DisclosureButton",props:{as:{type:[Object,String],default:"button"},disabled:{type:[Boolean],default:!1},id:{type:String,default:null}},setup(e,{attrs:a,slots:i,expose:n}){let t=_("DisclosureButton"),u=ce(),o=k(()=>u===null?!1:u.value===t.panelId.value);D(()=>{o.value||e.id!==null&&(t.buttonId.value=e.id)}),H(()=>{o.value||(t.buttonId.value=null)});let r=f(null);n({el:r,$el:r}),o.value||N(()=>{t.button.value=r.value});let p=le(k(()=>({as:e.as,type:a.type})),r);function w(){var l;e.disabled||(o.value?(t.toggleDisclosure(),(l=m(t.button))==null||l.focus()):t.toggleDisclosure())}function I(l){var x;if(!e.disabled)if(o.value)switch(l.key){case S.Space:case S.Enter:l.preventDefault(),l.stopPropagation(),t.toggleDisclosure(),(x=m(t.button))==null||x.focus();break}else switch(l.key){case S.Space:case S.Enter:l.preventDefault(),l.stopPropagation(),t.toggleDisclosure();break}}function A(l){l.key===S.Space&&l.preventDefault()}return()=>{var l;let x={open:t.disclosureState.value===0},{id:K,...Q}=e,J=o.value?{ref:r,type:p.value,onClick:w,onKeydown:I}:{id:(l=t.buttonId.value)!=null?l:K,ref:r,type:p.value,"aria-expanded":t.disclosureState.value===0,"aria-controls":t.disclosureState.value===0||m(t.panel)?t.panelId.value:void 0,disabled:e.disabled?!0:void 0,onClick:w,onKeydown:I,onKeyup:A};return B({ourProps:J,theirProps:Q,slot:x,attrs:a,slots:i,name:"DisclosureButton"})}}}),pe=C({name:"DisclosurePanel",props:{as:{type:[Object,String],default:"div"},static:{type:Boolean,default:!1},unmount:{type:Boolean,default:!0},id:{type:String,default:null}},setup(e,{attrs:a,slots:i,expose:n}){let t=_("DisclosurePanel");D(()=>{e.id!==null&&(t.panelId.value=e.id)}),H(()=>{t.panelId.value=null}),n({el:t.panel,$el:t.panel}),R(z,t.panelId);let u=te(),o=k(()=>u!==null?(u.value&q.Open)===q.Open:t.disclosureState.value===0);return()=>{var r;let p={open:t.disclosureState.value===0,close:t.close},{id:w,...I}=e,A={id:(r=t.panelId.value)!=null?r:w,ref:t.panel};return B({ourProps:A,theirProps:I,slot:p,attrs:a,slots:i,features:F.RenderStrategy|F.Static,visible:o.value,name:"DisclosurePanel"})}}});const me={class:"text-base font-semibold leading-7"},fe=["innerHTML"],ge={key:0,class:"flex gap-2 mt-2 flex-wrap"},ye=C({__name:"CollapseSection",props:{question:{},answer:{},show_all:{type:Boolean},buttons:{}},setup(e){return(a,i)=>(c(),g(b(de),{as:"div"},{default:h(({open:n})=>[s("dt",null,[d(b(he),{class:"flex w-full items-start justify-between text-left text-white cursor-pointer transition-all hover:bg-brand-950 px-4 py-2 rounded-2xl"},{default:h(()=>[s("span",me,P(e.question),1),d(G,{class:"ml-6 flex h-7 items-center"},{default:h(()=>[n||e.show_all?(c(),g(b(L),{key:0,icon:"memory:minus",class:"size-6","aria-hidden":"true"})):(c(),g(b(L),{key:1,icon:"memory:menu-down",class:"size-6 flex-none","aria-hidden":"true"}))]),_:2},1024)]),_:2},1024)]),d(G,null,{default:h(()=>[d(b(pe),{as:"dd",class:"mt-2 bg-brand-950 rounded-2xl py-2 px-4"},{default:h(()=>[s("div",{class:"text-base leading-7 text-gray-300",innerHTML:e.answer},null,8,fe),e.buttons.length>0?(c(),y("div",ge,[(c(!0),y($,null,U(e.buttons,t=>(c(),g(T,{title:t.title,external_link:"",href:t.href,icon:t.icon},{default:h(()=>[v(P(t.title),1)]),_:2},1032,["title","href","icon"]))),256))])):W("",!0)]),_:1})]),_:1})]),_:1}))}}),we={class:"flex justify-between"},be={class:"text-base font-semibold leading-7 text-light-001 truncate"},ve=["src"],ke=["innerHTML"],Ce={key:0,class:"mt-2 transition-all flex flex-col justify-between gap-2"},Se=C({__name:"BasicCard",props:{icon:{},iconHtml:{},iconImg:{},title:{},size:{},enableSearch:{type:Boolean},count:{},collapse:{type:Boolean},color:{}},setup(e){const a=e,i=f(a.collapse??!1),n=k(()=>a.size==="sm"?"p-4 sm:w-96 w-full":"p-4 sm:min-w-full");return(t,u)=>(c(),g(G,null,{default:h(()=>[s("div",{class:se([n.value,(e.color=="white","bg-brand-950")," p-4 sm:rounded-2xl transition-all object-shadow border-y sm:border border-brand-900"])},[s("div",null,[s("div",we,[s("h3",be,[e.icon?(c(),g(b(L),{key:0,icon:e.icon,class:"text-sm text-light-001 h-4 w-4 inline mr-3 mb-[3px] align-middle"},null,8,["icon"])):e.iconImg?(c(),y("img",{key:1,src:e.iconImg,class:"inline mr-2 w-6 h-6 rounded shadow"},null,8,ve)):(c(),y("div",{key:2,class:"inline-block h-4 w-4 pt-0.5 text-light-001 mr-2",innerHTML:e.iconHtml},null,8,ke)),s("span",null,P(e.title),1)])])]),i.value?W("",!0):(c(),y("div",Ce,[oe(t.$slots,"default",{},void 0,!0)]))],2)]),_:3}))}}),M=ae(Se,[["__scopeId","data-v-0e0d2677"]]),Ie={class:"p-6 flex flex-col gap-4 lg:grid grid-cols-3"},xe={class:"lg:order-last flex flex-col gap-4"},qe={class:"lg:col-span-2"},Ae={class:"bg-brand-950 p-4 sm:rounded-2xl mb-4"},Le=C({__name:"(Index)",setup(e){const a=ie({search:""}),i=[{question:"Can I use the art I find here? How should I credit the artist?",answer:`<p>
...
<ul class="list-disc pl-6">
                   ...
                   `,buttons:[]}],n=k(()=>{if(!a.search)return i;const u=a.search.toLowerCase();return i.filter(o=>o.question.toLowerCase().includes(u)||t(o.answer).toLowerCase().includes(u))}),t=u=>{const o=document.createElement("div");return o.innerHTML=u,o.textContent||o.innerText||""};return(u,o)=>(c(),y("div",null,[d(X),d(Z),s("div",Ie,[s("div",xe,[d(M,{icon:"memory:alert-box",title:"Instruction"},{default:h(()=>[o[3]||(o[3]=s("p",{class:""},"If you have a question that you think should be here, contact us via the Contact form and let us know.",-1)),d(T,{icon:"memory:chat",external_link:"",href:"https://opengameart.org/contact"},{default:h(()=>[...o[1]||(o[1]=[v("Contact Form",-1)])]),_:1}),o[4]||(o[4]=s("p",{class:""},"Please read our content submission guidelines before posting art.",-1)),d(T,{icon:"memory:chat",external_link:"",href:"https://opengameart.org/content/art-submission-guidelines"},{default:h(()=>[...o[2]||(o[2]=[v(" Submission Guidelines ",-1)])]),_:1})]),_:1}),d(M,{icon:"memory:alert-box",title:"Forum Rules"},{default:h(()=>[...o[5]||(o[5]=[s("p",null,[s("strong",null,"The basics:")],-1),s("ul",{class:"list-disc pl-6"},[s("li",null,"No discussion of religion."),s("li",null,"No discussion of politics, except relating directly to copyright, the Creative Commons, and/or FOSS."),s("li",null,"Don't be racist, homophobic, or otherwise hateful.")],-1),s("br",null,null,-1),s("p",null,[s("strong",null,"Conduct:")],-1),s("p",null," On some forums, it is okay to be snide.  That isn't acceptable here.  As a FOSS gaming community, we are ambassadors of FOSS in general, and as such it is not acceptable to be rude to people who are interested enough in what we do to take the time to ask questions.  Specifically, it is not okay to do the following: ",-1),s("ul",{class:"list-disc pl-6"},[s("li",null,'Say something along the lines of "READ TEH FAQ U IDIOT"'),s("li",null,"Reply to a question with a link to a google search"),s("li",null,'Say "SOMEONE ALREADY ASKED THIS READ TEH FORUM U IDIOT"'),s("li",null,"Talk down to anyone because of their choice of software or operating system")],-1),s("p",null,[v(" On the other hand, it's quite possible that we'll get certain questions over and over, which is the reason FAQs exist in the first place.  It "),s("em",null,"is"),v(" acceptable to reply with a link to a relevant FAQ question "),s("em",null,"provided you read their post carefully and make sure that it actually applies"),v(".  Just try to understand that when someone asks a question in a forum, they're looking for a personalized answer, and it's better to provide one and encourage discussion than just send them off to a FAQ link. ")],-1)])]),_:1})]),s("div",qe,[o[6]||(o[6]=s("h2",{class:"text-2xl font-bold leading-10 tracking-tight text-white mb-6"},"Frequently asked questions",-1)),s("div",Ae,[d(re,{modelValue:a.search,"onUpdate:modelValue":o[0]||(o[0]=r=>a.search=r),name:"Search"},null,8,["modelValue"])]),d(ne,{class:"flex flex-col gap-4"},{default:h(()=>[(c(!0),y($,null,U(n.value,r=>(c(),g(ye,{question:r.question,answer:r.answer,show_all:a.search!="",buttons:r.buttons},null,8,["question","answer","show_all","buttons"]))),256))]),_:1}),o[7]||(o[7]=s("div",{class:"TEST"},null,-1))])])]))}});export{Le as default};
