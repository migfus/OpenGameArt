import{$ as e,A as t,D as n,Dt as r,E as i,H as a,M as o,S as s,Tt as c,V as l,Z as u,_ as d,c as f,d as p,f as m,g as h,h as g,i as _,j as v,k as y,l as b,ot as x,t as S,u as C}from"./_plugin-vue_export-helper-COfKKufu.js";import{i as w,n as T,r as E,t as D}from"./DataTransition-Bbbs4Zjz.js";import{a as O,d as k,f as A,n as j,o as M,r as N,s as P,t as F,u as I}from"./keyboard-WrsQneFk.js";import{c as ee,t as L}from"./app-CzVFpY57.js";import{t as R}from"./NotifyBanner-BPcockO3.js";var z=(e=>(e[e.Open=0]=`Open`,e[e.Closed=1]=`Closed`,e))(z||{}),B=Symbol(`DisclosureContext`);function V(e){let t=s(B,null);if(t===null){let t=Error(`<${e} /> is missing a parent <Disclosure /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(t,V),t}return t}var H=Symbol(`DisclosurePanelContext`);function U(){return s(H,null)}var W=d({name:`Disclosure`,props:{as:{type:[Object,String],default:`template`},defaultOpen:{type:[Boolean],default:!1}},setup(n,{slots:r,attrs:i}){let a=e(n.defaultOpen?0:1),o=e(null),s=e(null),c={buttonId:e(`headlessui-disclosure-button-${A()}`),panelId:e(`headlessui-disclosure-panel-${A()}`),disclosureState:a,panel:o,button:s,toggleDisclosure(){a.value=I(a.value,{0:1,1:0})},closeDisclosure(){a.value!==1&&(a.value=1)},close(e){c.closeDisclosure(),(e?e instanceof HTMLElement?e:e.value instanceof HTMLElement?k(e):k(c.button):k(c.button))?.focus()}};return t(B,c),O(f(()=>I(a.value,{0:j.Open,1:j.Closed}))),()=>{let{defaultOpen:e,...t}=n;return M({theirProps:t,ourProps:{},slot:{open:a.value===0,close:c.close},slots:r,attrs:i,name:`Disclosure`})}}}),G=d({name:`DisclosureButton`,props:{as:{type:[Object,String],default:`button`},disabled:{type:[Boolean],default:!1},id:{type:String,default:null}},setup(t,{attrs:r,slots:a,expose:o}){let s=V(`DisclosureButton`),c=U(),u=f(()=>c===null?!1:c.value===s.panelId.value);i(()=>{u.value||t.id!==null&&(s.buttonId.value=t.id)}),n(()=>{u.value||(s.buttonId.value=null)});let d=e(null);o({el:d,$el:d}),u.value||l(()=>{s.button.value=d.value});let p=ee(f(()=>({as:t.as,type:r.type})),d);function m(){var e;t.disabled||(u.value?(s.toggleDisclosure(),(e=k(s.button))==null||e.focus()):s.toggleDisclosure())}function h(e){var n;if(!t.disabled)if(u.value)switch(e.key){case F.Space:case F.Enter:e.preventDefault(),e.stopPropagation(),s.toggleDisclosure(),(n=k(s.button))==null||n.focus();break}else switch(e.key){case F.Space:case F.Enter:e.preventDefault(),e.stopPropagation(),s.toggleDisclosure();break}}function g(e){switch(e.key){case F.Space:e.preventDefault();break}}return()=>{let e={open:s.disclosureState.value===0},{id:n,...i}=t;return M({ourProps:u.value?{ref:d,type:p.value,onClick:m,onKeydown:h}:{id:s.buttonId.value??n,ref:d,type:p.value,"aria-expanded":s.disclosureState.value===0,"aria-controls":s.disclosureState.value===0||k(s.panel)?s.panelId.value:void 0,disabled:t.disabled?!0:void 0,onClick:m,onKeydown:h,onKeyup:g},theirProps:i,slot:e,attrs:r,slots:a,name:`DisclosureButton`})}}}),K=d({name:`DisclosurePanel`,props:{as:{type:[Object,String],default:`div`},static:{type:Boolean,default:!1},unmount:{type:Boolean,default:!0},id:{type:String,default:null}},setup(e,{attrs:r,slots:a,expose:o}){let s=V(`DisclosurePanel`);i(()=>{e.id!==null&&(s.panelId.value=e.id)}),n(()=>{s.panelId.value=null}),o({el:s.panel,$el:s.panel}),t(H,s.panelId);let c=N(),l=f(()=>c===null?s.disclosureState.value===0:(c.value&j.Open)===j.Open);return()=>{let t={open:s.disclosureState.value===0,close:s.close},{id:n,...i}=e;return M({ourProps:{id:s.panelId.value??n,ref:s.panel},theirProps:i,slot:t,attrs:r,slots:a,features:P.RenderStrategy|P.Static,visible:l.value,name:`DisclosurePanel`})}}}),q={class:`text-base font-semibold leading-7`},J=[`innerHTML`],Y={key:0,class:`flex gap-2 mt-2 flex-wrap`},X=d({__name:`CollapseSection`,props:{question:{},answer:{},show_all:{type:Boolean},buttons:{}},setup(e){return(t,n)=>(y(),C(x(W),{as:`div`},{default:a(({open:t})=>[b(`dt`,null,[h(x(G),{class:`flex w-full items-start justify-between text-left text-white cursor-pointer transition-all hover:bg-brand-950 px-4 py-2 rounded-2xl`},{default:a(()=>[b(`span`,q,r(e.question),1),h(E,{class:`ml-6 flex h-7 items-center`},{default:a(()=>[t||e.show_all?(y(),C(x(w),{key:0,icon:`memory:minus`,class:`size-6`,"aria-hidden":`true`})):(y(),C(x(w),{key:1,icon:`memory:menu-down`,class:`size-6 flex-none`,"aria-hidden":`true`}))]),_:2},1024)]),_:2},1024)]),h(E,null,{default:a(()=>[h(x(K),{as:`dd`,class:`mt-2 bg-brand-950 rounded-2xl py-2 px-4`},{default:a(()=>[b(`div`,{class:`text-base leading-7 text-gray-300`,innerHTML:e.answer},null,8,J),e.buttons.length>0?(y(),m(`div`,Y,[(y(!0),m(_,null,v(e.buttons,e=>(y(),C(T,{title:e.title,external_link:``,href:e.href,icon:e.icon},{default:a(()=>[g(r(e.title),1)]),_:2},1032,[`title`,`href`,`icon`]))),256))])):p(``,!0)]),_:1})]),_:1})]),_:1}))}}),Z={class:`flex justify-between`},Q={class:`text-base font-semibold leading-7 text-light-001 truncate`},te=[`src`],ne=[`innerHTML`],re={key:0,class:`mt-2 transition-all flex flex-col justify-between gap-2`},$=S(d({__name:`BasicCard`,props:{icon:{},iconHtml:{},iconImg:{},title:{},size:{},enableSearch:{type:Boolean},count:{},collapse:{type:Boolean},color:{}},setup(t){let n=t,i=e(n.collapse??!1),s=f(()=>{switch(n.size){case`sm`:return`p-4 sm:w-96 w-full`;default:return`p-4 sm:min-w-full`}});return(e,n)=>(y(),C(E,null,{default:a(()=>[b(`div`,{class:c([s.value,(t.color,`bg-brand-950`),` p-4 sm:rounded-2xl transition-all object-shadow border-y sm:border border-brand-900`])},[b(`div`,null,[b(`div`,Z,[b(`h3`,Q,[t.icon?(y(),C(x(w),{key:0,icon:t.icon,class:`text-sm text-light-001 h-4 w-4 inline mr-3 mb-0.75 align-middle`},null,8,[`icon`])):t.iconImg?(y(),m(`img`,{key:1,src:t.iconImg,class:`inline mr-2 w-6 h-6 rounded shadow`},null,8,te)):(y(),m(`div`,{key:2,class:`inline-block h-4 w-4 pt-0.5 text-light-001 mr-2`,innerHTML:t.iconHtml},null,8,ne)),b(`span`,null,r(t.title),1)])])]),i.value?p(``,!0):(y(),m(`div`,re,[o(e.$slots,`default`,{},void 0,!0)]))],2)]),_:3}))}}),[[`__scopeId`,`data-v-b991b491`]]),ie={class:`p-6 flex flex-col gap-4 lg:grid grid-cols-3`},ae={class:`lg:order-last flex flex-col gap-4`},oe={class:`lg:col-span-2`},se={class:`bg-brand-950 p-4 sm:rounded-2xl mb-4`},ce=d({__name:`faqs`,setup(e){let t=u({search:``}),n=[{question:`Can I use the art I find here? How should I credit the artist?`,answer:`<p>
