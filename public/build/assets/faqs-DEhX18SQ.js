import{A as e,B as t,E as n,Et as r,O as i,Q as a,T as o,V as s,X as c,at as l,c as u,d,g as f,h as p,j as m,k as h,l as g,m as _,r as v,s as y,u as b,wt as x,x as S}from"./runtime-core.esm-bundler-CCcfCGFe.js";import{n as C,r as w,t as T}from"./DataTransition-CcwOmWog.js";import{a as E,d as D,f as O,n as k,o as A,r as j,s as M,t as N,u as P}from"./keyboard-C6Q2LVZk.js";import{t as ee}from"./_plugin-vue_export-helper-DAAOZMkq.js";import{l as te,r as F,t as I}from"./app-CThgB9_W.js";import{t as L}from"./NotifyBanner-CIFroU8b.js";var R=(e=>(e[e.Open=0]=`Open`,e[e.Closed=1]=`Closed`,e))(R||{}),z=Symbol(`DisclosureContext`);function B(e){let t=S(z,null);if(t===null){let t=Error(`<${e} /> is missing a parent <Disclosure /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(t,B),t}return t}var V=Symbol(`DisclosurePanelContext`);function H(){return S(V,null)}var U=f({name:`Disclosure`,props:{as:{type:[Object,String],default:`template`},defaultOpen:{type:[Boolean],default:!1}},setup(e,{slots:t,attrs:n}){let r=a(e.defaultOpen?0:1),i=a(null),o=a(null),s={buttonId:a(`headlessui-disclosure-button-${O()}`),panelId:a(`headlessui-disclosure-panel-${O()}`),disclosureState:r,panel:i,button:o,toggleDisclosure(){r.value=P(r.value,{0:1,1:0})},closeDisclosure(){r.value!==1&&(r.value=1)},close(e){s.closeDisclosure(),(e?e instanceof HTMLElement?e:e.value instanceof HTMLElement?D(e):D(s.button):D(s.button))?.focus()}};return h(z,s),E(y(()=>P(r.value,{0:k.Open,1:k.Closed}))),()=>{let{defaultOpen:i,...a}=e;return A({theirProps:a,ourProps:{},slot:{open:r.value===0,close:s.close},slots:t,attrs:n,name:`Disclosure`})}}}),W=f({name:`DisclosureButton`,props:{as:{type:[Object,String],default:`button`},disabled:{type:[Boolean],default:!1},id:{type:String,default:null}},setup(e,{attrs:r,slots:i,expose:s}){let c=B(`DisclosureButton`),l=H(),u=y(()=>l===null?!1:l.value===c.panelId.value);o(()=>{u.value||e.id!==null&&(c.buttonId.value=e.id)}),n(()=>{u.value||(c.buttonId.value=null)});let d=a(null);s({el:d,$el:d}),u.value||t(()=>{c.button.value=d.value});let f=te(y(()=>({as:e.as,type:r.type})),d);function p(){var t;e.disabled||(u.value?(c.toggleDisclosure(),(t=D(c.button))==null||t.focus()):c.toggleDisclosure())}function m(t){var n;if(!e.disabled)if(u.value)switch(t.key){case N.Space:case N.Enter:t.preventDefault(),t.stopPropagation(),c.toggleDisclosure(),(n=D(c.button))==null||n.focus();break}else switch(t.key){case N.Space:case N.Enter:t.preventDefault(),t.stopPropagation(),c.toggleDisclosure();break}}function h(e){switch(e.key){case N.Space:e.preventDefault();break}}return()=>{let t={open:c.disclosureState.value===0},{id:n,...a}=e;return A({ourProps:u.value?{ref:d,type:f.value,onClick:p,onKeydown:m}:{id:c.buttonId.value??n,ref:d,type:f.value,"aria-expanded":c.disclosureState.value===0,"aria-controls":c.disclosureState.value===0||D(c.panel)?c.panelId.value:void 0,disabled:e.disabled?!0:void 0,onClick:p,onKeydown:m,onKeyup:h},theirProps:a,slot:t,attrs:r,slots:i,name:`DisclosureButton`})}}}),G=f({name:`DisclosurePanel`,props:{as:{type:[Object,String],default:`div`},static:{type:Boolean,default:!1},unmount:{type:Boolean,default:!0},id:{type:String,default:null}},setup(e,{attrs:t,slots:r,expose:i}){let a=B(`DisclosurePanel`);o(()=>{e.id!==null&&(a.panelId.value=e.id)}),n(()=>{a.panelId.value=null}),i({el:a.panel,$el:a.panel}),h(V,a.panelId);let s=j(),c=y(()=>s===null?a.disclosureState.value===0:(s.value&k.Open)===k.Open);return()=>{let n={open:a.disclosureState.value===0,close:a.close},{id:i,...o}=e;return A({ourProps:{id:a.panelId.value??i,ref:a.panel},theirProps:o,slot:n,attrs:t,slots:r,features:M.RenderStrategy|M.Static,visible:c.value,name:`DisclosurePanel`})}}}),K={class:`text-base font-semibold leading-7`},q=[`innerHTML`],J={key:0,class:`flex gap-2 mt-2 flex-wrap`},Y=f({__name:`CollapseSection`,props:{question:{},answer:{},show_all:{type:Boolean},buttons:{}},setup(t){return(n,a)=>(i(),g(l(U),{as:`div`},{default:s(({open:n})=>[u(`dt`,null,[p(l(W),{class:`flex w-full items-start justify-between text-left text-white cursor-pointer transition-all hover:bg-brand-950 px-4 py-2 rounded-2xl`},{default:s(()=>[u(`span`,K,r(t.question),1),p(C,{class:`ml-6 flex h-7 items-center`},{default:s(()=>[n||t.show_all?(i(),g(l(w),{key:0,icon:`memory:minus`,class:`size-6`,"aria-hidden":`true`})):(i(),g(l(w),{key:1,icon:`memory:menu-down`,class:`size-6 flex-none`,"aria-hidden":`true`}))]),_:2},1024)]),_:2},1024)]),p(C,null,{default:s(()=>[p(l(G),{as:`dd`,class:`mt-2 bg-brand-950 rounded-2xl py-2 px-4`},{default:s(()=>[u(`div`,{class:`text-base leading-7 text-gray-300`,innerHTML:t.answer},null,8,q),t.buttons.length>0?(i(),d(`div`,J,[(i(!0),d(v,null,e(t.buttons,e=>(i(),g(F,{title:e.title,external_link:``,href:e.href,icon:e.icon},{default:s(()=>[_(r(e.title),1)]),_:2},1032,[`title`,`href`,`icon`]))),256))])):b(``,!0)]),_:1})]),_:1})]),_:1}))}}),X={class:`flex justify-between`},Z={class:`text-base font-semibold leading-7 text-light-001 truncate`},ne=[`src`],re=[`innerHTML`],Q={key:0,class:`mt-2 transition-all flex flex-col justify-between gap-2`},$=ee(f({__name:`BasicCard`,props:{icon:{},iconHtml:{},iconImg:{},title:{},size:{},enableSearch:{type:Boolean},count:{},collapse:{type:Boolean},color:{}},setup(e){let t=e,n=a(t.collapse??!1),o=y(()=>{switch(t.size){case`sm`:return`p-4 sm:w-96 w-full`;default:return`p-4 sm:min-w-full`}});return(t,a)=>(i(),g(C,null,{default:s(()=>[u(`div`,{class:x([o.value,(e.color,`bg-brand-950`),` p-4 sm:rounded-2xl transition-all object-shadow border-y sm:border border-brand-900`])},[u(`div`,null,[u(`div`,X,[u(`h3`,Z,[e.icon?(i(),g(l(w),{key:0,icon:e.icon,class:`text-sm text-light-001 h-4 w-4 inline mr-3 mb-0.75 align-middle`},null,8,[`icon`])):e.iconImg?(i(),d(`img`,{key:1,src:e.iconImg,class:`inline mr-2 w-6 h-6 rounded shadow`},null,8,ne)):(i(),d(`div`,{key:2,class:`inline-block h-4 w-4 pt-0.5 text-light-001 mr-2`,innerHTML:e.iconHtml},null,8,re)),u(`span`,null,r(e.title),1)])])]),n.value?b(``,!0):(i(),d(`div`,Q,[m(t.$slots,`default`,{},void 0,!0)]))],2)]),_:3}))}}),[[`__scopeId`,`data-v-b991b491`]]),ie={class:`p-6 flex flex-col gap-4 lg:grid grid-cols-3`},ae={class:`lg:order-last flex flex-col gap-4`},oe={class:`lg:col-span-2`},se={class:`bg-brand-950 p-4 sm:rounded-2xl mb-4`},ce=f({__name:`faqs`,setup(t){let n=c({search:``}),r=[{question:`Can I use the art I find here? How should I credit the artist?`,answer:`<p>
...
<ul class="list-disc pl-6">
                   ...
                   `,buttons:[]}],a=y(()=>{if(!n.search)return r;let e=n.search.toLowerCase();return r.filter(t=>t.question.toLowerCase().includes(e)||l(t.answer).toLowerCase().includes(e))}),l=e=>{let t=document.createElement(`div`);return t.innerHTML=e,t.textContent||t.innerText||``};return o(()=>{document.title=`FAQs | OGA (Not Official)`}),(t,r)=>(i(),d(`div`,null,[p(L),u(`div`,ie,[u(`div`,ae,[p($,{icon:`memory:alert-box`,title:`Instruction`},{default:s(()=>[r[3]||=u(`p`,{class:``},`If you have a question that you think should be here, contact us via the Contact form and let us know.`,-1),p(F,{icon:`memory:chat`,external_link:``,href:`https://opengameart.org/contact`},{default:s(()=>[...r[1]||=[_(`Contact Form`,-1)]]),_:1}),r[4]||=u(`p`,{class:``},`Please read our content submission guidelines before posting art.`,-1),p(F,{icon:`memory:chat`,external_link:``,href:`https://opengameart.org/content/art-submission-guidelines`},{default:s(()=>[...r[2]||=[_(` Submission Guidelines `,-1)]]),_:1})]),_:1}),p($,{icon:`memory:alert-box`,title:`Forum Rules`},{default:s(()=>[...r[5]||=[u(`p`,null,[u(`strong`,null,`The basics:`)],-1),u(`ul`,{class:`list-disc pl-6`},[u(`li`,null,`No discussion of religion.`),u(`li`,null,`No discussion of politics, except relating directly to copyright, the Creative Commons, and/or FOSS.`),u(`li`,null,`Don't be racist, homophobic, or otherwise hateful.`)],-1),u(`br`,null,null,-1),u(`p`,null,[u(`strong`,null,`Conduct:`)],-1),u(`p`,null,` On some forums, it is okay to be snide.\xA0 That isn't acceptable here.\xA0 As a FOSS gaming community, we are ambassadors of FOSS in general, and as such it is not acceptable to be rude to people who are interested enough in what we do to take the time to ask questions.\xA0 Specifically, it is not okay to do the following: `,-1),u(`ul`,{class:`list-disc pl-6`},[u(`li`,null,`Say something along the lines of "READ TEH FAQ U IDIOT"`),u(`li`,null,`Reply to a question with a link to a google search`),u(`li`,null,`Say "SOMEONE ALREADY ASKED THIS READ TEH FORUM U IDIOT"`),u(`li`,null,`Talk down to anyone because of their choice of software or operating system`)],-1),u(`p`,null,[_(` On the other hand, it's quite possible that we'll get certain questions over and over, which is the reason FAQs exist in the first place.\xA0 It `),u(`em`,null,`is`),_(` acceptable to reply with a link to a relevant FAQ question `),u(`em`,null,`provided you read their post carefully and make sure that it actually applies`),_(`.\xA0 Just try to understand that when someone asks a question in a forum, they're looking for a personalized answer, and it's better to provide one and encourage discussion than just send them off to a FAQ link. `)],-1)]]),_:1})]),u(`div`,oe,[r[6]||=u(`h2`,{class:`text-2xl font-bold leading-10 tracking-tight text-white mb-6`},`Frequently asked questions`,-1),u(`div`,se,[p(I,{modelValue:n.search,"onUpdate:modelValue":r[0]||=e=>n.search=e,name:`Search`},null,8,[`modelValue`])]),p(T,{class:`flex flex-col gap-4`},{default:s(()=>[(i(!0),d(v,null,e(a.value,e=>(i(),g(Y,{question:e.question,answer:e.answer,show_all:n.search!=``,buttons:e.buttons},null,8,[`question`,`answer`,`show_all`,`buttons`]))),256))]),_:1}),r[7]||=u(`div`,{class:`TEST`},null,-1)])])]))}});export{ce as default};